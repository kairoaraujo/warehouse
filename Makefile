...
inittuf:
	$(WAREHOUSE_CLI) tuf keypair --name root --path /opt/warehouse/src/dev/tufkeys/root
	$(WAREHOUSE_CLI) tuf keypair --name snapshot --path /opt/warehouse/src/dev/tufkeys/snapshot
	$(WAREHOUSE_CLI) tuf keypair --name targets --path /opt/warehouse/src/dev/tufkeys/targets
	$(WAREHOUSE_CLI) tuf keypair --name timestamp --path /opt/warehouse/src/dev/tufkeys/timestamp
	$(WAREHOUSE_CLI) tuf keypair --name bins --path /opt/warehouse/src/dev/tufkeys/bins
	$(WAREHOUSE_CLI) tuf keypair --name bin-n --path /opt/warehouse/src/dev/tufkeys/bin-n
